...
export default function QuotationsPage() {
    ...
    const handleDownloadPdf = async (quotation: Quotation) => {
        try {
            ...
            const html = `
                <div style="font-family: inherit; color: #111; width: 800px; background: white; margin: 0; box-sizing: border-box; padding: 24px;">
                    <!-- Header -->
                    <div style="display: flex; justify-content: space-between; align-items: flex-start; padding-top: 12px;">
                        <div>
                    ...
                    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 24px;">
                        <div>
                            ...
                            <div style="font-size: 18px; font-weight: 600;">${details.clientName}</div>
                            <div style="font-size: 14px; color: #4b5563; margin-top: 4px;">${details.clientAddress}</div>
                            <div style="font-size: 14px; color: #4b5563; margin-top: 2px;">${details.clientEmail}</div>
                            <div style="font-size: 14px; color: #4b5563;">${details.clientPhone}</div>
                        </div>
                        <div style="text-align: right;">
                            ...
                            <div style="margin-top: 8px; font-size: 14px; color: #6b7280;">Project: <span style="font-weight: 500; color: #111;">${details.projectName}</span></div>
                        </div>
                    </div>
